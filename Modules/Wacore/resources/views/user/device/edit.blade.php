			...
			<div class="card-body">
				...
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">
						<i class="fab fa-telegram" style="color:#229ED9"></i> {{ __('Telegram Bot Token') }}
					</label>
					<div class="col-sm-12 col-md-7">
						<input type="text" name="telegram_token" value="{{ $device->telegram_token ?? '' }}"
							placeholder="1234567890:AAFxxxxxxxxxx-xxxxxxxxxxxxxxxxxxxxxxx"
							class="form-control" style="font-size:.82rem;font-family:monospace;">
						<small class="text-muted">
							{{ __('Optional. Get it from') }} <a href="https://t.me/BotFather" target="_blank">@BotFather</a>.
							{{ __('After saving, register the webhook:') }}<br>
							<code style="font-size:.75rem;word-break:break-all;">POST https://api.telegram.org/bot<b>{TOKEN}</b>/setWebhook?url={{ rtrim(config('app.url'),'/') }}/api/telegram-webhook/<b>{TOKEN}</b></code>
						</small>
					</div>
				</div>
