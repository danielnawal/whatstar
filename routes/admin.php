...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth','admin']], function (){
	...
	// Appogio SSO: el admin genera el token SSO para cualquier cliente
	Route::post('/appogio/sso/generate/{id}', [App\Http\Controllers\AppogioController::class, 'adminGenerateSsoToken'])->name('appogio.sso.generate');
