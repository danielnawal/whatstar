...
Route::group(['middleware' => ['throttle:api']], function (){
    ...
    Route::get('/contacts/export','App\Http\Controllers\Api\ContactExportController@index');
    Route::post('/telegram-webhook/{token}','App\Http\Controllers\Api\TelegramWebhookController@webhook');
