...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => ['auth','user','saas']], function (){
   ...
   Route::get('chatbot-stats',                            [USER\ChatbotStatsController::class, 'index'])->name('chatbot.stats');
   ...
   Route::get('chatbot-widget',                           [USER\ChatbotWidgetController::class, 'index'])->name('chatbot.widget');
   //log report route
